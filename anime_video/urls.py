...
urlpatterns = [
    ...
    path('actors/', cache_page(30)(views.PersonageList.as_view()), name='personage-list'),
    path('actors/<int:pk>/', views.PersonageDetail.as_view(), name='personage-detail'),
    path('genre/', cache_page(30)(views.GenreList.as_view()), name='genre-list'),
    path('genre/<int:pk>/', views.GenreDetail.as_view(), name='genre-detail'),
    path('shots/', cache_page(30)(views.VideoShotsList.as_view()), name='shots-list'),
]
